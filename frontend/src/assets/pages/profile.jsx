...
const Profile = () => {
  ...
  const menuItems = [
    {
      section: "Account",
      items: [
        { label: "Personal Information", icon: <User className="w-4 h-4 text-blue-500" />, bg: "bg-blue-50", path: "/personal-information" },
  ...
  return (
    <>
      <div className=" bg-black/90 backdrop-blur-md min-h-screen max-w-md mx-auto flex text-white overflow-y-auto flex-col ">
        {/* Header */}
        ...
        <div className="flex flex-col items-center px-5 pb-6">
          <div className="w-20 h-20 rounded-full bg-blue-600 flex items-center justify-center text-white text-2xl font-extrabold mb-3 shadow-lg">
            {getInitials(storedUser.accountName)}
          </div>
          <h2 className="text-xl font-extrabold text-gray-400">{storedUser.firstName || "User"}</h2>
        ...
        <div className="mx-5 grid grid-cols-2 gap-3 mb-6">
          {[
            { label: "Username", value: storedUser.accountName, icon: <User className="w-4 h-4 text-blue-500" /> },
